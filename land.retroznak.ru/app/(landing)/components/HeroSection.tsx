...
export function HeroSection() {
  const { eyebrow, title, subtitle, primaryCta, secondaryCta, visual } = heroContent;
      ...
      <div className="container relative z-20 grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center">
        <div className="space-y-8 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <div className="space-y-5 text-balance">
            <h1 className="text-4xl font-semibold leading-none text-white sm:text-5xl md:text-[3.25rem]">
              {typografTitle}
            </h1>
