...
export const metadata: Metadata = {
  title: typograf("Согласие на обработку персональных данных"),
  description: typograf("Согласие на обработку персональных данных пользователя сайта ООО «Три Кита»"),
  robots: {
    index: false,
    follow: false,
  },
      ...
      <main className="container py-12">
        <article className="prose prose-sm prose-zinc dark:prose-invert mx-auto max-w-4xl">
          ...
          <div className="mb-8 mt-4">
            <Link href="/#hero" className="inline-block transition-opacity hover:opacity-80" aria-label={typograf("Вернуться на главную")}>
