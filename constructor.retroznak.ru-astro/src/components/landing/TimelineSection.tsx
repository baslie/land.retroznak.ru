                  ...
                  <SwiperSlide key={item.id}>
                    <article className="flex h-full flex-col overflow-hidden rounded-3xl border border-border bg-card">
                      <div className="relative h-60 w-full cursor-pointer" onClick={() => openLightbox(items.indexOf(item))}>
                        <img src={item.image.src} alt={item.image.alt} className="object-cover absolute inset-0 w-full h-full" />
                      </div>
              ...
              {expertQuote.image && (
                ...
                >
                  <img
                    ...
                    className="object-cover scale-[1.10] absolute inset-0 w-full h-full"
                  />
                </div>
              )}
